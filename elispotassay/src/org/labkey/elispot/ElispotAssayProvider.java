...
public class ElispotAssayProvider extends AbstractPlateBasedAssayProvider implements DetectionMethodAssayProvider
{
    ...
    protected Pair<Domain, Map<DomainProperty, Object>> createAntigenWellGroupDomain(Container c)
    {
        ...
        antigenWellGroupDomain.setDescription("Define the antigen properties for this assay design. The user will be prompted to enter these properties for each of the antigen well groups in their chosen plate template.");
    ...
    protected Pair<Domain, Map<DomainProperty, Object>> createAnalyteDomain(Container c)
    {
        ...
        analyteWellGroupDomain.setDescription("Define the analyte properties for this assay design. The user will be prompted to enter these properties for each of the analyte well groups.");
