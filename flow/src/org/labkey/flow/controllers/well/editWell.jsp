...
<labkey:errors />
<form method="POST" action="<%=h(well.urlFor(WellController.EditWellAction.class))%>">
    <table>
...
<% } %>
    ...
    <labkey:button text="cancel" href="<%=well.urlFor(WellController.ShowWellAction.class)%>"/>
</form>
