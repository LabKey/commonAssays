...
import com.labkey.flow.model.Polygon;
...
public class FlowAnalyzer
{
    ...
    static private CompensationCalculation.ChannelSubset readSubsetDef(ChannelSubsetDef subsetDef)
    {
        ...
        return new com.labkey.flow.model.CompensationCalculation.ChannelSubset(criteria, subset);
    }

    static private void fillSubsetDef(ChannelSubsetDef subsetDef, com.labkey.flow.model.CompensationCalculation.ChannelSubset subset)
    {
    ...
    {
        com.labkey.flow.model.CompensationCalculation ret = new com.labkey.flow.model.CompensationCalculation();
        ...
        {
            com.labkey.flow.model.CompensationCalculation.ChannelSubset positive = readSubsetDef(channel.getPositive());
            com.labkey.flow.model.CompensationCalculation.ChannelSubset negative = readSubsetDef(channel.getNegative());
    ...
    static public void makeAnalysis(ScriptDef script, CompensationCalculation compensationCalculation, PopulationSet analysis)
    {
        ...
        if (compensationCalculation != null)
        {
            ...
            for (com.labkey.flow.model.CompensationCalculation.ChannelInfo info : compensationCalculation.getChannels())
            {
