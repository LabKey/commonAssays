...
<input type="checkbox" id="<%= MicroarrayBulkPropertiesDisplayColumn.ENABLED_FIELD_NAME %>" <%= existingValue != null ? "checked" : "" %>
...
<br/>
<textarea <%= existingValue == null ? "style=\"display: none;\"" : "" %>
        style="width: 100%"
