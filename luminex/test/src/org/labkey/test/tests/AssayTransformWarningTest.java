...
public final class AssayTransformWarningTest extends BaseWebDriverTest
{
    ...
    public void testJavaTransformWarning()
    {
        ...
        File tmpFile = clickAndWaitForDownload(Locator.linkContainingText(".tmp"));
        ...
        assertEquals("Temp file didn't contain correct rows", importData, TestFileUtils.getFileContents(tmpFile).replace("\r\n", "\n"));
        assertEquals("Wrong text in file generated by tranform", "This is test file 1 (Java).", TestFileUtils.getFileContents(extraFile1).trim());
        assertEquals("Wrong text in file generated by tranform", "This is test file 2 (Java).", TestFileUtils.getFileContents(extraFile2).trim());
    ...
    public void testRTransformWarning()
    {
        ...
        assertEquals("Wrong text in file generated by tranform", "This is test file 1 (R).", TestFileUtils.getFileContents(extraFile1).trim());
        assertEquals("Wrong text in file generated by tranform", "This is test file 2 (R).", TestFileUtils.getFileContents(extraFile2).trim());
