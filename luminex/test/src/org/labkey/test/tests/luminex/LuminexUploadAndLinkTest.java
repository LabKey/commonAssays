...
public final class LuminexUploadAndLinkTest extends LuminexTest
{
    ...
    @Test
    public void testUploadAndLink()
    {
        clickProject(TEST_ASSAY_PRJ_LUMINEX);
        _listHelper.importListArchive(getProjectName(), TestFileUtils.getSampleData("luminex/UploadAndLink.lists.zip"));
        ...
        addUrlParameter("Data.showRows=all", defaultWaitForPage * 3);
