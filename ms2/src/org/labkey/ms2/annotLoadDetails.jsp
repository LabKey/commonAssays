...
<tr>
   <td align='left' class="labkey-form-label">Completed</td><td align='right'><%=insertion.getCompletionDate() == null ? "Not complete" : h(DateUtil.formatDateTime(insertion.getCompletionDate()))%></td><td align='right'><%=h(DateUtil.formatDateTime(insertion.getChangeDate()))%></td>
</tr>
<tr>
