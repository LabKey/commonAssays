...
<%
    OldMS2Controller.GoChartBean bean = ((JspView<OldMS2Controller.GoChartBean>) HttpView.currentView()).getModelBean();
%>
...
<table align="left">
<tr><td>
<input type="image" src="<%=PageFlowUtil.buttonSrc("GO Piechart")%>">
