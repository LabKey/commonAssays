...
public abstract class MS2Importer
{
    ...
    static
    {
        ...
        */
        ...
        sql.append("                WHERE I.Identifier = Protein AND SeqId IN (SELECT SeqId FROM ").append(ProteinSchema.getTableInfoFastaSequences()).append(" WHERE FastaId = ?))");
    ...
    static
    {
        ...
        _updateSequencePositionSql = new SQLFragment("UPDATE ").append(MS2Manager.getTableInfoPeptidesData()).append(" SET SequencePosition = COALESCE(\n" +
...
//            }
    ...
    private void updateCounts(MS2Progress progress)
    {
        ...
        String negativeHitLike = ProteinService.NEGATIVE_HIT_PREFIX + "%";
