...
public class SequestPipelineJob extends AbstractMS2SearchPipelineJob
{
    ...
    @JsonCreator
    protected SequestPipelineJob(@JsonProperty("_dirSequenceRoot") FileLike dirSequenceRoot)
    {
    ...
    public SequestPipelineJob(SequestPipelineJob job, FileLike fileFraction)
    {
