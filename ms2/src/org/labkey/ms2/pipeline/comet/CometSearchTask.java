...
public class CometSearchTask extends AbstractMS2SearchTask<CometSearchTask.Factory>
{
    ...
    public RecordedActionSet run() throws PipelineJobException
    {
        try
        {
            ...
            FileLike fileWorkParams = _wd.newFile(COMET_PARAMS);
            ...
            FileLike pepXMLFile = TPPTask.FT_PEP_XML.getFile(_wd.getDir(), getJob().getBaseName());
            ...
            try (WorkDirectory.CopyingResource ignored = _wd.ensureCopyingLock())
            {
                ...
                FileLike jobSpecificCometParamsFile = COMET_PARAMS_FILE_TYPE.getFile(fileWorkParams.getParent(), getJob().getBaseName());
                fileWorkParams.move(jobSpecificCometParamsFile);
                ...
                for (FileLike file : getJob().getSequenceFiles())
                {
