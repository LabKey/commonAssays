 ...
 */
ALTER TABLE ms2.MS2ProteinProphetFiles ADD UploadCompleted BIT DEFAULT 0
GO

ALTER TABLE ms2.MS2ProteinProphetFiles ALTER COLUMN UploadCompleted BIT NOT NULL
GO
