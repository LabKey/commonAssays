...
<form action="updateEmailPreferences.post" method="post">
    ...
    Send me emails for responses to threads I've posted to<br>
    <input type="radio" value="1" name="emailPreference" <%=emailPreference == 1 ? " checked" : ""%>>
    Send me email for all posts<br>
    <input type="radio" value="3" name="emailPreference" <%=emailPreference == 3 ? " checked" : ""%>>
    Send me a daily digest email for all posts<br>
    <br>
