...
<table>
    ...
    <tr>
        ...
        <td><table><tr><td class="normal"><input type="checkbox" name="assignedTo"<%=settings.hasAssignedTo() ? " checked" : ""%>><td class="ms-searchform">Default Assigned To</td><td><%=assignedToSelect%></td></tr></table></td>
    </tr>
    <tr>
