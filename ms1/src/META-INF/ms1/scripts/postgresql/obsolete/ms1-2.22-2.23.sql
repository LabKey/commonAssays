...
SELECT core.fn_dropifexists('PeaksToFamilies', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('Peaks', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('PeakFamilies', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('CalibrationParams', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('Calibrations', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('Scans', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('PeaksFiles', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('Features', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('FeaturesFiles', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('PeaksToFamilies', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('FilesToSoftware', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('FileSoftwareParams', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('SoftwareParams', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('Software', 'ms1', 'TABLE','');
SELECT core.fn_dropifexists('Files', 'ms1', 'TABLE','');
